...
class NginxSiteEnableCommandTest extends \PHPUnit_Framework_TestCase
{
    protected $app;
    protected $tester;
    protected $process;
    ...
    protected function setUp()
    {
        ...
        $command = new NginxSiteEnableCommand(
            $this->processBuilder,
            new Normaliser
        );
     ...
     */
    public function testNginxSiteEnableThrowsRuntimeExceptionWithUnknownSite()
    {
        $this
            ->processBuilder
            ->expects($this->once())
        ...
        $this->tester->execute(array(
            'command' => $this->app->find('nginx:ensite')->getName(),
            'site-name' => 'not_a_site',
        ));
    }

    public function testNginxSiteEnableExitsWhenSiteIsAlreadyEnabled()
    {
        $this
            ->processBuilder
     ...
     */
    public function testNginxSiteEnableThrowsRuntimeExceptionWhenFailsToEnable()
    {
        $this
            ->processBuilder
    ...
    public function testNginxSiteEnableWillEnableDisabledSite()
    {
        $this
            ->processBuilder
            ->expects($this->exactly(3))
    ...
    public function testNginxSiteEnableWillReportOnlyInCheckMode()
    {
        $this
            ->processBuilder
            ->expects($this->exactly(2))
